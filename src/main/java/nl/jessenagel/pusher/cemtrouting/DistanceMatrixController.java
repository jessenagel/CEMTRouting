...
public class DistanceMatrixController {
    ...
    public DistanceMatrixController(CEMTGraph graph) {this.graph = graph;}
    @GetMapping("/distanceMatrix")
    public DistanceMatrix distanceMatrix(@RequestParam(value= "coordinates", defaultValue = "Empty") String coordinates, @RequestParam(value = "CEMTClass", defaultValue = "Empty") String CEMTClass){
        ...
        try {
            ...
            for (JsonNode node : rootNode) {
                ...
                CEMTNode cemtNode = graph.getNodeOrNearest(lat, lon);
